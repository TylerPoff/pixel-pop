...
public class LoginActivityPixelPop extends AppCompatActivity {

    private static final String TAG = "a8_stickers.LoginActivityPixelPop";
    ...
    public void openActivityRegister() {
        Intent intent = new Intent(this, RegisterActivityPixelPop.class);
